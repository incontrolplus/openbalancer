...
(function () {
  const translations = {
    en: {
      ...
      // Blog Hub & Articles
      "blog_hub_tag": "Engineering & Architecture Insights",
      "blog_hub_title": "OpenBalancer Engineering Blog",
      "blog_hub_desc": "Technical deep dives, benchmarks, zero-copy socket architecture, and LLM inference routing strategies.",
      "blog_filter_all": "All Posts",
      "blog_filter_releases": "Releases",
      "blog_filter_arch": "Architecture",
      "blog_filter_benchmarks": "Benchmarks",
      "blog_filter_ai": "AI & LLM",
      "blog_read_more": "Read Article &rarr;",
      "blog_read_time_5": "5 min read",
      "blog_read_time_6": "6 min read",
      "blog_read_time_7": "7 min read",
      "blog_read_time_8": "8 min read",
      ...
      "blog_post2_tag": "Architecture &bull; Deep Dive &bull; Aug 12, 2026",
      "blog_post2_title": "Zero-Copy Socket Pipelines vs Traditional Buffered Proxies",
      "blog_post2_excerpt": "Why kernel-to-user memory buffering introduces latency spikes during multi-gigabit token streaming, and how native asyncio stream splicing achieves sub-millisecond TTFT.",
      "blog_post3_tag": "Benchmarks &bull; Performance &bull; Aug 05, 2026",
      "blog_post3_title": "Benchmarking 100,000 Concurrent SSE Connections: 12ms p99 at Scale",
      "blog_post3_excerpt": "A rigorous latency comparison across Envoy, NGINX, HAProxy, and OpenBalancer under concurrent SSE LLM token streaming traffic on bare-metal.",
      "blog_post4_tag": "AI & LLM &bull; Optimization &bull; Jul 28, 2026",
      "blog_post4_title": "Adaptive Power-of-Two (P2C) Routing for vLLM & Ollama Clusters",
      "blog_post4_excerpt": "How least-pending-tokens heuristic and proactive OOM circuit breakers prevent queue head-of-line blocking in heterogeneous GPU inference clusters.",
    ...
    bg: {
      ...
      // Blog Hub & Articles
      "blog_hub_tag": "Инженерни Анализи и Архитектура",
      "blog_hub_title": "Инженерен Блог OpenBalancer",
      "blog_hub_desc": "Дълбочинни технически анализи, бенчмаркове, zero-copy сокет архитектура и стратегии за маршрутизиране на AI инференция.",
      "blog_filter_all": "Всички Публикации",
      "blog_filter_releases": "Версии",
      "blog_filter_arch": "Архитектура",
      "blog_filter_benchmarks": "Бенчмаркове",
      "blog_filter_ai": "AI Инференция",
      "blog_read_more": "Прочети статията &rarr;",
      "blog_read_time_5": "5 мин четене",
      "blog_read_time_6": "6 мин четене",
      "blog_read_time_7": "7 мин четене",
      "blog_read_time_8": "8 мин четене",
      ...
      "blog_post2_tag": "Архитектура &bull; Дълбочинен анализ &bull; 12 Авг 2026",
      "blog_post2_title": "Zero-Copy Сокет Канали срещу Традиционни Буферирани Проксита",
      "blog_post2_excerpt": "Защо прехвърлянето на памет от ядрото към потребителското пространство води до пикове в латентността при гигабитов токен стрийминг и как asyncio постига суб-милисекунден TTFT.",
      "blog_post3_tag": "Бенчмаркове &bull; Производителност &bull; 05 Авг 2026",
      "blog_post3_title": "Бенчмарк при 100,000 Паралелни SSE Връзки: 12ms p99 при мащаб",
      "blog_post3_excerpt": "Прецизно сравнение на латентността между Envoy, NGINX, HAProxy и OpenBalancer при паралелен SSE LLM токен стрийминг на bare-metal сървъри.",
      "blog_post4_tag": "AI & LLM &bull; Оптимизация &bull; 28 Юли 2026",
      "blog_post4_title": "Адаптивно Power-of-Two (P2C) Маршрутизиране за vLLM и Ollama Клъстери",
      "blog_post4_excerpt": "Как евристиката за най-малко чакащи токени и проактивните прекъсвачи предотвратяват блокирането на опашки при разнородни GPU клъстери.",
